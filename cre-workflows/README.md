...
# HackaTriathlon Snapshot Publisher (CRE)

This CRE project publishes the latest heart-rate snapshot from the HackaTriathlon telemetry API to Arc Testnet.

Current deployed CRE-compatible consumer:

- `CRETelemetryReceiver`: `0xD05247c2cBE8f38f90ebd85AcECdFF9cce7d16F1`

Workflow directory:

- [snapshot-publisher](/Users/agustinschiariti/Desktop/PreCannes/cre-workflows/snapshot-publisher)

Successful simulation proof:

- `cre workflow simulate ./snapshot-publisher -R . -T staging-settings -e /tmp/cre-sim.env --non-interactive --trigger-index 0 --broadcast`
- broadcast tx: `0xb2176a12ce3cceb745c9d9f1b786ac663c5df8837b1b6a111eb0c8e9b3c75ef5`
